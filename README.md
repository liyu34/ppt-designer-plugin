...
方法论提炼自 LINUX DO 社区的精华帖：

> **《应该是目前最强的PPT Agent，附上完整思路分享》**
> 作者：Sandun（三顿）· 发布于 2026-03-19 · LINUX DO「开发调优」分类 · 标签：人工智能 / 软件开发 / 精华神帖
> 链接：<https://linux.do/t/topic/1782304>

本插件沿用了帖中作者公开分享的核心方法论与提示词思路——五阶段专家工作流（需求调研 → 资料搜集 → 金字塔大纲/数字便利贴 → 策划稿 → 设计稿）、"顶级PPT结构架构师"的大纲 JSON 结构、便当网格（Bento Grid）卡片式布局规范、整页 SVG（viewBox 0 0 1280 720，可拖入 Office 2016+）的技术选型。5 种风格设计系统（色彩/字体/页型规范）为在此基础上原创实现。
